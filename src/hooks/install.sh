...
#   or:  bash <(curl -s https://raw.githubusercontent.com/smg-real-estate/caveman/main/src/hooks/install.sh)
...
REPO_URL="https://raw.githubusercontent.com/smg-real-estate/caveman/main/src/hooks"
