...
//   curl -fsSL https://raw.githubusercontent.com/smg-real-estate/caveman/main/src/tools/caveman-init.js | node - [args]
//
...
function processOpenclaw(opts) {
  ...
  if (!helper) {
    return {
      ...
      label: 'x',
      detail: '~/.openclaw/workspace (helper unavailable in standalone curl|node mode — use `npx -y github:smg-real-estate/caveman -- --only openclaw`)',
    };
  }
